const dataEmprendedores = {
    ...
    "la-monita": {
        ...
        productos: [
            { id: "prod-15", nombre: "Miel Artesanal 500g", precio: 200.00, imagen: "../assets/images/productos/miel la monita.png", descripcion: "Miel de producción casera, sin conservadores." }
        ],
